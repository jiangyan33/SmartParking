...
namespace Zhaoxi.SmartParking.Client.Upgrade
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            var str = e.Args;
#if DEBUG
            var msg = "麻精药品智能管理柜.doc|3457842|http://localhost:5000/api/Files/download/麻精药品智能管理柜.doc|Modules|123456;WeGameMiniLoader.std.2.07.29.1736.exe|8124096|http://localhost:5000/api/Files/download/WeGameMiniLoader.std.2.07.29.1736.exe|Modules|12345678";
